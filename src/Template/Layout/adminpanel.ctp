...
<head>
    ...
    <?= $this->Html->script('plugins/flot/jquery.flot.spline') ?>
    <?= $this->Html->script('plugins/flot/jquery.flot.resize') ?>
    <?= $this->Html->script('plugins/flot/jquery.flot.pie') ?>


    <!-- Peity -->
    <?= $this->Html->script('plugins/peity/jquery.peity.min') ?>
    ...
    <!-- GITTER -->
    <?= $this->Html->script('plugins/gritter/jquery.gritter.min') ?>
    ...
    <!-- Sparkline demo data  -->
    <?= $this->Html->script('demo/sparkline-demo') ?>
